...
//#region src/option.ts
	...
	(function(_Issue) {
		_Issue.ParentChildType = /* @__PURE__ */ function(ParentChildType) {
			...
			ParentChildType[ParentChildType["GrandchildIssue"] = 5] = "GrandchildIssue";
			ParentChildType[ParentChildType["ChildIssue"] = 6] = "ChildIssue";
			ParentChildType[ParentChildType["ParentIssue"] = 7] = "ParentIssue";
			ParentChildType[ParentChildType["ExcludeGrandchild"] = 8] = "ExcludeGrandchild";
			ParentChildType[ParentChildType["ExcludeGrandparent"] = 9] = "ExcludeGrandparent";
			ParentChildType[ParentChildType["LeafIssue"] = 10] = "LeafIssue";
