...
type types_ActivityType = ActivityType;
declare const types_ActivityType: typeof ActivityType;
type types_ClassicRoleType = ClassicRoleType;
declare const types_ClassicRoleType: typeof ClassicRoleType;
type types_CustomFieldType = CustomFieldType;
declare const types_CustomFieldType: typeof CustomFieldType;
type types_IssueTypeColor = IssueTypeColor;
type types_Language = Language;
type types_NormalRoleType = NormalRoleType;
declare const types_NormalRoleType: typeof NormalRoleType;
type types_ProjectStatusColor = ProjectStatusColor;
type types_RoleType = RoleType;
type types_TextFormattingRule = TextFormattingRule;
type types_WebhookActivityId = WebhookActivityId;
declare namespace types {
  export { types_ActivityType as ActivityType, types_ClassicRoleType as ClassicRoleType, types_CustomFieldType as CustomFieldType, type types_IssueTypeColor as IssueTypeColor, type types_Language as Language, types_NormalRoleType as NormalRoleType, type types_ProjectStatusColor as ProjectStatusColor, type types_RoleType as RoleType, type types_TextFormattingRule as TextFormattingRule, type types_WebhookActivityId as WebhookActivityId };
}
...
type option_Order = Order;
declare namespace option {
  export { Document$1 as Document, Issue$1 as Issue, Notification$1 as Notification, OAuth2$2 as OAuth2, type option_Order as Order, Project$1 as Project, PullRequest$1 as PullRequest, Space$1 as Space, Team$1 as Team, User$1 as User, WatchingList$1 as WatchingList, Wiki$1 as Wiki };
}
...
declare const entity_Activity: typeof Activity;
declare const entity_ChangeLog: typeof ChangeLog;
declare const entity_CommentNotification: typeof CommentNotification;
declare const entity_DiskUsage: typeof DiskUsage;
declare const entity_Document: typeof Document;
declare const entity_File: typeof File;
declare const entity_Git: typeof Git;
declare const entity_Issue: typeof Issue;
declare const entity_License: typeof License;
declare const entity_Notification: typeof Notification;
declare const entity_Project: typeof Project;
declare const entity_PullRequest: typeof PullRequest;
declare const entity_RateLimit: typeof RateLimit;
declare const entity_Space: typeof Space;
declare const entity_Star: typeof Star;
declare const entity_Team: typeof Team;
declare const entity_User: typeof User;
declare const entity_WatchingList: typeof WatchingList;
declare const entity_Webhook: typeof Webhook;
declare const entity_Wiki: typeof Wiki;
declare namespace entity {
  export { entity_Activity as Activity, entity_ChangeLog as ChangeLog, entity_CommentNotification as CommentNotification, entity_DiskUsage as DiskUsage, entity_Document as Document, entity_File as File, entity_Git as Git, entity_Issue as Issue, entity_License as License, entity_Notification as Notification, OAuth2$1 as OAuth2, entity_Project as Project, entity_PullRequest as PullRequest, entity_RateLimit as RateLimit, entity_Space as Space, entity_Star as Star, entity_Team as Team, entity_User as User, entity_WatchingList as WatchingList, entity_Webhook as Webhook, entity_Wiki as Wiki };
}
...
type error_BacklogApiError = BacklogApiError;
declare const error_BacklogApiError: typeof BacklogApiError;
type error_BacklogAuthError = BacklogAuthError;
declare const error_BacklogAuthError: typeof BacklogAuthError;
type error_BacklogError = BacklogError;
declare const error_BacklogError: typeof BacklogError;
type error_BacklogErrorMessage = BacklogErrorMessage;
type error_BacklogErrorNameType = BacklogErrorNameType;
type error_UnexpectedError = UnexpectedError;
declare const error_UnexpectedError: typeof UnexpectedError;
declare namespace error {
  export { error_BacklogApiError as BacklogApiError, error_BacklogAuthError as BacklogAuthError, error_BacklogError as BacklogError, type error_BacklogErrorMessage as BacklogErrorMessage, type error_BacklogErrorNameType as BacklogErrorNameType, error_UnexpectedError as UnexpectedError };
}

export { Backlog, entity as Entity, error as Error, OAuth2, option as Option, types as Types };
